...
func (s *Server) processBalance(block *database.Block) {
...
// makeBlock converts golos-go Block type to protobuf-specified Block type
func makeBlock(block *database.Block) (pb.Block) {
	pbBlock := pb.Block{
		Height:block.Number,
